...
- example-latex-typesets: Example LaTeX typesets. Many of them are XeTeX, actually. 
...
- vincr and vincbot - Tools for calculating "vinculum", a mechanic used in certain types of World of Darkness LARP games. 
